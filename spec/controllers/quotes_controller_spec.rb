...
describe QuotesController do
  ...
  let(:valid_attributes) { { "bike_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved quote as @quote" do
        ...
        post :create, {:quote => { "bike_id" => "invalid value" }}, valid_session
        assigns(:quote).should be_a_new(Quote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quote" do
        ...
        Quote.any_instance.should_receive(:update).with({ "bike_id" => "1" })
        put :update, {:id => quote.to_param, :quote => { "bike_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the quote as @quote" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quote.any_instance.stub(:save).and_return(false)
        put :update, {:id => quote.to_param, :quote => { "bike_id" => "invalid value" }}, valid_session
        assigns(:quote).should eq(quote)
      end
